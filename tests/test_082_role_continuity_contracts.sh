...
verify_coder_reviewer_persist_sessions() {
    echo "Running verify_coder_reviewer_persist_sessions..."
    # 1. Coder (Persists)
...
verify_planner_verifier_no_persist() {
    echo "Running verify_planner_verifier_no_persist..."
