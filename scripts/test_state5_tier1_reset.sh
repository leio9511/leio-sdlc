...
INNER_EOF
    ...
    git status
    python3 scripts/orchestrator.py --channel "#test" --workdir "$(pwd)" --prd-file docs/PRDs/TestProject.md --max-prs-to-process 1 --coder-session-strategy always > ../orchestrator.log 2>&1 || true
