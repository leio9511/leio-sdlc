...
def test_spawn_auditor_load_balancing(mock_notify, mock_get_keys, mock_assign_key, mock_invoke, mock_run, capsys):
    ...
    mock_assign_key.return_value = "sticky_key_XYZ"
    
    mock_run.return_value.returncode = 0
    mock_run.return_value.stdout = ""
    mock_run.return_value.stderr = ""
    
    # Needs a mock return for invoke_agent
    ...
    # We must pop GEMINI_API_KEY if it's there
    ...
    assert os.environ.get("GEMINI_API_KEY") == "sticky_key_XYZ"
    os.remove(prd_file)
