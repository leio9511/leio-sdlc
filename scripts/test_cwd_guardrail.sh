...
if python3 scripts/orchestrator.py --enable-exec-from-workspace --workdir "$INNER_DIR" --prd-file "prd.md" --channel "#test" --global-dir "$PROJECT_ROOT" 2>&1 | grep -q "Git Boundary"; then
