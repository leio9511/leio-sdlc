...
python3 /root/.openclaw/workspace/projects/leio-sdlc/scripts/spawn_reviewer.py --pr-file PR_001.md --diff-target master --workdir "$WORK_DIR" > output.log
...
python3 /root/.openclaw/workspace/projects/leio-sdlc/scripts/spawn_reviewer.py --pr-file PR_001.md --diff-target master --workdir "$WORK_DIR" > output.log || true
